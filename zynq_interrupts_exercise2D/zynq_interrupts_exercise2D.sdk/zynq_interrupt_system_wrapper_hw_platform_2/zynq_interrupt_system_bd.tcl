...
proc create_root_design { parentCell } {
  ...
  set switches_4bits_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 switches_4bits_0 ]
  ...
  set_property -dict [ list CONFIG.C_INTERRUPT_PRESENT {0} CONFIG.GPIO_BOARD_INTERFACE {sws_4bits} CONFIG.USE_BOARD_FLOW {true}  ] $axi_gpio_2
...
CONFIG.PCW_USB0_RESET_IO {MIO 46} CONFIG.PCW_USE_FABRIC_INTERRUPT {1} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports switches_4bits_0] [get_bd_intf_pins axi_gpio_2/GPIO]
